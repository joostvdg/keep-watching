...
public class MoviesController {
    ...
    private final ResponseEntity<Movie> notAuthorizedResponse;
    ...
    @ResponseBody
    public ResponseEntity<Movie> updateMovie(@AuthenticationPrincipal OAuth2User principal,@Parameter(description = "Movie to update") @RequestBody Movie movie)  {
        if (principal == null) {return notAuthorizedResponse;}
